...
extract.SigTerms <- function(FET.table,pvalue.cutoff = 0.05,fold.cutoff = 2,pval.colname,fold.colname = "enrichment.foldchange")
{
 ...
 sig.module <- factor(FET.table$module[ii])
 sig.term <- as.character(FET.table$id[ii])
